...
If `FILE` is syntactically correct there is no output.  The exit code is 0.

If `FILE` has syntax errors the errors will be written to stderr.  The exit code is 1.
